...
const UserEngagementMetrics: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800">User Engagement Metrics</h1>
        ...
        {userMetrics.map((metric, index) => (
          <div key={index} className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center mb-4">
              ...
              {index === 1 && <Activity className="h-6 w-6 text-green-500 mr-2" />}
              {index === 2 && <Calendar className="h-6 w-6 text-purple-500 mr-2" />}
              {index === 3 && <ShoppingCart className="h-6 w-6 text-orange-500 mr-2" />}
              <h2 className="text-lg font-medium text-gray-700">{metric.name}</h2>
            </div>
            <div className="flex items-end justify-between">
              <p className="text-3xl font-bold text-gray-900">
                {metric.name.includes('Average') ? metric.value.toFixed(1) : metric.value.toLocaleString()}
              </p>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={timeSeriesData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
              ...
              <Tooltip />
              <Legend />
              <Line type="monotone" dataKey="newUsers" stroke="#8884d8" activeDot={{ r: 8 }} name="New Users" />
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              <h2 className="text-lg font-medium text-gray-800">Order Activity</h2>
            </div>
            <div className="text-sm text-gray-500">
              <select className="border rounded px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                <option value="monthly">Monthly</option>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-lg font-medium text-gray-800">Popular Categories</h2>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <ResponsiveContainer width="100%" height={250}>
            <BarChart data={timeSpentData} layout="vertical" margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis type="number" />
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-8">
        <div className="flex items-center mb-6">
          ...
          <h2 className="text-lg font-medium text-gray-800">Daily Activity Patterns</h2>
        </div>
        <ResponsiveContainer width="100%" height={300}>
          <LineChart
            data={[
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-8">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center">
            ...
            <h2 className="text-lg font-medium text-gray-800">User Retention Preview</h2>
          </div>
          <button
            className="text-blue-600 flex items-center hover:text-blue-800"
            onClick={() => alert('Navigating to detailed retention analysis...')}
          >
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {['January', 'February', 'March', 'April', 'May'].map((month, idx) => (
                <tr key={month}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{Math.floor(Math.random() * 500) + 500}</td>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="border rounded-lg p-4 bg-blue-50 border-blue-100">
            <h3 className="font-medium text-blue-800 mb-2">User Growth Trend</h3>
            <p className="text-blue-700">User growth has increased by 24% compared to the previous period. The most significant growth is observed in the mobile user segment.</p>
          </div>
          <div className="border rounded-lg p-4 bg-green-50 border-green-100">
            <h3 className="font-medium text-green-800 mb-2">Engagement Patterns</h3>
            <p className="text-green-700">Average session duration has improved by 17%. Users spend the most time browsing Fruits & Vegetables and Dairy & Eggs categories.</p>
          </div>
          <div className="border rounded-lg p-4 bg-purple-50 border-purple-100">
            <h3 className="font-medium text-purple-800 mb-2">Retention Opportunities</h3>
            <p className="text-purple-700">User retention drops significantly after week 2. Consider implementing targeted engagement strategies for this time period.</p>
          </div>
          <div className="border rounded-lg p-4 bg-orange-50 border-orange-100">
            <h3 className="font-medium text-orange-800 mb-2">Peak Usage Times</h3>
            <p className="text-orange-700">Platform usage peaks between 6 PM - 8 PM. Consider scheduling promotions and new product launches during these high-traffic hours.</p>
          </div>
        </div>
      </div>
    </div>
