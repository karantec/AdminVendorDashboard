...
const UserAccountList = () => {
  ...
  const getStatusBadge = (status) => {
    const badgeClasses = {
      ...
      inactive:
        "bg-error-100 text-error-700 dark:bg-error-900/30 dark:text-error-500",
      pending:
        "bg-warning-100 text-warning-700 dark:bg-warning-900/30 dark:text-warning-500",
    };
    ...
    <div className="bg-white dark:bg-gray-900 rounded-xl shadow">
      ...
      <div className="overflow-x-auto">
        {loading ? (
          ...
          <div className="p-6 text-center text-error-600 dark:text-error-500">
            {error}
          </div>
              ...
              {users.map((user) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <Link
                      to={`/users/${user._id}`}
                      className="text-blue-light-600 hover:text-blue-light-900 dark:hover:text-blue-light-400 mr-4"
                    >
                      View
                    </Link>
                    <Link
