        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card>
            <CardContent>
              ...
              <Typography variant="h4">{filteredVendors.length}</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card>
            <CardContent>
              ...
              <Typography variant="h4">
                {filteredVendors.reduce(
                  (acc, vendor) => acc + vendor.ordersCompleted,
                  0
                )}
              </Typography>
            </CardContent>
          ...
          <Card>
            <CardContent>
              ...
              <Typography variant="h4">
                $
                {filteredVendors
                  .reduce((acc, vendor) => acc + vendor.revenue, 0)
                  .toLocaleString()}
              </Typography>
            </CardContent>
          </Card>
