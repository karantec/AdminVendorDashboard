...
const DUMMY_ISSUES = [
  ...
  },
  {
    ...
    notes: [
      "Contacted customer to get more details",
      "Offered replacement or refund",
    ],
  },
  {
    id: "ISS-003",
    ...
    notes: [
      "Delivery was delayed due to traffic accident",
      "Customer was understanding",
      "Issued $5 credit as goodwill",
    ],
  },
  {
    id: "ISS-004",
...
const HandleOrderIssues = () => {
  // State
  const [issues, setIssues] = useState(DUMMY_ISSUES);
  const [filteredIssues, setFilteredIssues] = useState(DUMMY_ISSUES);
  ...
  const updateIssueStatus = (newStatus, resolution) => {
    if (!selectedIssue) return;
    ...
    setTimeout(() => {
      const updatedIssue = {
        ...
        assignedTo:
          newStatus === "new"
            ? undefined
            : selectedIssue.assignedTo || "Current User",
      };
      ...
      {isDetailView && selectedIssue ? (
        ...
        <Box>
          ...
          <Dialog
            ...
            fullWidth
          >
            <DialogTitle>Resolve Issue {selectedIssue.id}</DialogTitle>
            <DialogContent>
