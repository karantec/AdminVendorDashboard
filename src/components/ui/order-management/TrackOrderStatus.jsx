...
const dummyOrders: Order[] = [
  {
    ...
    items: [
      { id: '101', name: 'Organic Bananas', quantity: 2, price: 0.99, image: '/images/bananas.jpg' },
      { id: '102', name: 'Whole Grain Bread', quantity: 1, price: 3.49, image: '/images/bread.jpg' },
      { id: '103', name: 'Almond Milk', quantity: 1, price: 2.99, image: '/images/almond-milk.jpg' },
    ],
    totalAmount: 8.46,
  ...
  },
  {
    ...
    status: 'delivered',
    items: [
      { id: '201', name: 'Chicken Breast', quantity: 1, price: 8.99, image: '/images/chicken.jpg' },
      { id: '202', name: 'Broccoli', quantity: 2, price: 1.49, image: '/images/broccoli.jpg' },
    ],
    totalAmount: 11.97,
    deliveryAddress: '123 Main St, Apt 4B, New York, NY 10001',
  ...
  },
  {
    ...
    status: 'cancelled',
    items: [
      { id: '301', name: 'Avocados', quantity: 3, price: 1.29, image: '/images/avocados.jpg' },
      { id: '302', name: 'Tomatoes', quantity: 6, price: 0.79, image: '/images/tomatoes.jpg' },
    ],
    totalAmount: 8.01,
    deliveryAddress: '123 Main St, Apt 4B, New York, NY 10001',
...
const OrderStatusPage: React.FC = () => {
  ...
  useEffect(() => {
    // Simulate API fetch
    const active = dummyOrders.find(order => 
      order.status !== 'delivered' && order.status !== 'cancelled'
    );
    const past = dummyOrders.filter(order => 
      order.status === 'delivered' || order.status === 'cancelled'
    );
  ...
  const getStatusSteps = (): StatusStep[] => {
    return [
      ...
      { label: 'Out for Delivery', icon: <LocalShipping />, status: 'out-for-delivery' },
  ...
  const renderOrderStatusStepper = (order: Order): React.ReactNode => {
  ...
  const renderDeliveryPersonInfo = (deliveryPerson?: DeliveryPerson): React.ReactNode => {
