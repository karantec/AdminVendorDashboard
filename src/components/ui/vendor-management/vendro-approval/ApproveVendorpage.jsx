...
import { VendorApplication } from './vendorTypes';
import VendorApprovalCard from './VendorApprovalCard';
import axios from 'axios';
import { API_URL } from '../config';

const ApproveVendorPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchPendingVendors = async () => {
      try {
        ...
        const dummyData: VendorApplication[] = [
          {
            _id: '1',
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800">Approve New Vendors</h1>
        ...
        <div>
          <div className="mb-4">
            <p className="text-gray-700">
              Showing <span className="font-semibold">{pendingVendors.length}</span> pending applications
            </p>
          </div>
